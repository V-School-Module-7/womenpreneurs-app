...
const SignUpTwo = (props) => {
  ...
  const callLinkedIn = () => {
   window.open(`http://www.linkedin.com/oauth/v2/authorization?response_type=code&client_id=86pzo1h1r9o6iu&redirect_uri=http://localhost:3000/auth/linkedin&state=vrstr238957xvbthg&scope=r_liteprofile`, 'iframe')
  }
  ...
  const handleNext = () => {
    ...
    return (
      <CenteredContainer>
        ...
        <LinkedInButton type='button' onClick={callLinkedIn}>Authorize LinkedIn</LinkedInButton>
        ...
        <Form>
          ...
          <span style={{display: 'flex', justifyContent: 'space-around', width: '297px'}}>
            ...
            <IncrementButton primary onClick={handleNext}>
              Next ▶
            </IncrementButton>
          </span>
        </Form>
